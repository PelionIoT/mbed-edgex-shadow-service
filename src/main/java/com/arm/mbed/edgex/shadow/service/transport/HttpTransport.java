...
import com.arm.mbed.edgex.shadow.service.core.KeyValuePair;
            ...
            if (this.m_sc != null) {
                ...
                if (doSSL == true) {
                    ...
                    if (verb != null && verb.equalsIgnoreCase("patch") == true) {
                        ...
                        // https://stackoverflow.com/questions/25163131/httpurlconnection-invalid-http-method-patch
                        //
                        ((HttpURLConnection) connection).setRequestProperty("X-HTTP-Method-Override","PATCH");
                ...
                if (doSSL == true) {
                    // save off the HTTPS response code & ETag if we have one...
                    ...
                    this.saveETagValue(((HttpURLConnection) connection).getHeaderFields());
                }
                ...
                // no security context setup...
                this.errorLogger().critical("HttpTransport(" + verb + "): Secure Context NOT SETUP: URL: " + url_str);
