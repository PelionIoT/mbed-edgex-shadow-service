...
public class JSONGeneratorFactory {
    ...
    private static volatile JSONGeneratorFactory me = null;
    ...
    public static JSONGeneratorFactory getInstance() {
        if (JSONGeneratorFactory.me == null) {
            JSONGeneratorFactory.me = new JSONGeneratorFactory();
        }
        return JSONGeneratorFactory.me;
    }
